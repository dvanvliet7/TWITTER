...
if (!isset($_SESSION['temp_session'])) {
    header('location: http://localhost:3000/Final/login.php');
    exit;
}
?>
            ...
            <div class="col-md-5">
                <div class="card bg-dark text-white">
                    <div class="card-body">
                        ...
                        <form>
                            <div class="mb-3">
                                <label class="form-label fs-5">OTP</label>
                            ...
                            <hr>
                            <div class="float-end">
                                <button type="button" class="btn btn-primary pin-btn" onclick="isCorrectPin()">Submit</button>
